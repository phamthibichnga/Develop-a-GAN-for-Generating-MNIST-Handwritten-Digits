...
<a name="tongquan"></a>
**- Result of GAN model for generating handwritten digits using MNIST dataset. These are alphanumeric images generated from the GAN model over a number of epochs**
